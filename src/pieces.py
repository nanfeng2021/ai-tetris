...
# 方块初始形状
PIECE_SHAPES = {
    PieceType.I: [[True, True, True, True]],
    PieceType.O: [[True, True], [True, True]],
    PieceType.T: [[False, True, False], [True, True, True]],
    PieceType.S: [[False, True, True], [True, True, False]],
    PieceType.Z: [[True, True, False], [False, True, True]],
    PieceType.J: [[True, False, False], [True, True, True]],
    PieceType.L: [[False, False, True], [True, True, True]],
}
...
if __name__ == "__main__":
    ...
    for i in range(14):  # 显示 14 个方块（2 轮）
        ...
        print(
            f"{i+1:2d}. {piece.type.value:2s} - 颜色：{piece.color} - 尺寸：{piece.width}x{piece.height}"
        )
