...
def test_monitor_creation():
    ...
    print("✅ 监控器创建成功，game_id={monitor.game_id}")
...
def test_update_level_and_lines():
    ...
    print("✅ 等级和行数更新成功：level=3, lines=10")
...
def test_record_ai_decision():
    ...
    print("✅ 记录 AI 决策延迟：0.5s")

    # 超时延迟 (应该触发 Guardrail)
    monitor.record_ai_decision(3.0)
    print("✅ 记录 AI 决策延迟：3.0s (超时)")
...
def test_get_metrics():
    ...
    print("✅ Prometheus 格式指标生成成功")
    print("   指标长度：{len(metrics)} 字符")
    print("   示例:\n{metrics[:500]}...")
